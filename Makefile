...
ifeq ($(UNAME_S),Darwin)
.PHONY: metal-decode-schedule-bench metal-prefill-variant-bench check-mxfp4-half-lut test-indexer-topk test-indexer-scorers
...
clean:
	rm -f tests/test_topk_ab tests/test_indexer_scorers
